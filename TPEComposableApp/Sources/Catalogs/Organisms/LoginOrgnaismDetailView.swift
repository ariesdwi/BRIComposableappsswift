...
struct LoginOrganismDetailView: View {
...
// MARK: - Supporting Views for Organism Catalog

struct LoginVariantCard: View {
    let variant: LoginOrganismDetailView.LoginVariant
    let isSelected: Bool
    let action: () -> Void
...
struct LiveLoginDemo: View {
    let variant: LoginOrganismDetailView.LoginVariant
    let settings: LoginOrganismDetailView.LoginCustomizationSettings
